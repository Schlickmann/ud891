    ...
    filter: function (str) {
      ...
      if (foundItems === 0) {
        ...
        for (var i = 0; i < this.visibleItems.length; i++) {
          ...
          item.setAttribute("aria-posinset", i + 1); // index of element visible in the list
          item.setAttribute("aria-setsize", this.visibleItems.length); // total number of elements in the visible list
        }
      }
    },
